...
export function updatePointClouds(pointclouds, camera, renderer, time){
...
export function updateVisibilityStructures(pointclouds, camera, renderer, time) {
	let frustums = [];
	let camObjPositions = [];
...
export function updateVisibility(pointclouds, camera, renderer, time){
